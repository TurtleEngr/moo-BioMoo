$Header: /repo/public.cvs/app/BioGate/BioMooCore/core43.moo,v 1.1 2021/07/27 06:44:31 bruce Exp $

>@dump #43 with create
@create $generic_utils named time utilities:time utilities,time
@prop #43."monthlens" {} rc
;;#43.("monthlens") = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31}
@prop #43."timezones" {} rc
;;#43.("timezones") = {{"AuEST", -10}, {"AuCST", -9}, {"AuWST", -8}, {"WET", -1}, {"GMT", 0}, {"AST", 4}, {"EDT", 4}, {"EST", 5}, {"CDT", 5}, {"CST", 6}, {"MDT", 6}, {"MST", 7}, {"PDT", 7}, {"PST", 8}, {"HST", 10}}
@prop #43."stsd" 2427 rc
@prop #43."ctcd" 7276 rc
@prop #43."ct" 7934 rc
@prop #43."corr" -122 rc
@prop #43."dayabbrs" {} rc
;;#43.("dayabbrs") = {"Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"}
@prop #43."days" {} rc
;;#43.("days") = {"Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"}
@prop #43."months" {} rc
;;#43.("months") = {"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"}
@prop #43."monthabbrs" {} rc
;;#43.("monthabbrs") = {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"}
@prop #43."zones" {} rc
;;#43.("zones") = {{{"est", "edt", "Massachusetts", "MA"}, 10800}, {{"cst", "cdt"}, 7200}, {{"mst", "mdt"}, 3600}, {{"pst", "pdt", "California", "CA", "Lambda"}, 0}, {{"gmt"}, 28800}}
@prop #43."time_units" {} rc
;;#43.("time_units") = {{31536000, "year", "years", "yr", "yrs"}, {2628000, "month", "months", "mo", "mos"}, {604800, "week", "weeks", "wk", "wks"}, {86400, "day", "days", "dy", "dys"}, {3600, "hour", "hours", "hr", "hrs"}, {60, "minute", "minutes", "min", "mins"}, {1, "second", "seconds", "sec", "secs"}}
...
;;#43.("aliases") = {"time utilities", "time"}
;;#43.("description") = {"This is the time utilities utility package.  See `help $time_utils' for more details."}
;;#43.("object_size") = {20472, 855068591}

@verb #43:"day" none none none rxd
@program #43:day
...
@verb #43:"month" none none none rxd
@program #43:month
...
@verb #43:"ampm" none none none rxd
@program #43:ampm
...
@verb #43:"to_seconds" this none this
@program #43:to_seconds
...
@verb #43:"from_ctime" this none this
@program #43:from_ctime
...
@verb #43:"dhms dayshoursminutesseconds" this none this
@program #43:dhms
s = args[1];
if (s < 0)
  return "-" + this:(verb)(-s);
...
@verb #43:"english_time" this none this
@program #43:english_time
...
@verb #43:"from_day" this none this
@program #43:from_day
...
@verb #43:"from_month" this none this
@program #43:from_month
...
@verb #43:"dst_midnight" this none this
@program #43:dst_midnight
...
@verb #43:"time_sub" this none this
@program #43:time_sub
...
@verb #43:"mmddyy ddmmyy" this none this
@program #43:mmddyy
...
@verb #43:"parse_english_time_interval" this none this
@program #43:parse_english_time_interval
...
@verb #43:"seconds_until_date" this none this rx
@program #43:seconds_until_date
...
@verb #43:"seconds_until_time" this none this rx
@program #43:seconds_until_time
...
@verb #43:"short_time" this none this rxd #96
@program #43:short_time
su = $string_utils;
time = args[1];
if (length(args) > 1)
  parts = args[2];

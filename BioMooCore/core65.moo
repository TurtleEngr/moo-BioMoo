$Header: /repo/public.cvs/app/BioGate/BioMooCore/core65.moo,v 1.1 2021/07/27 06:44:34 bruce Exp $
...
;;#65.("names") = {"include", "all", "followup", "nosubject", "expert", "enter", "sticky", "@mail", "manymsgs", "replyto", "netmail", "expire", "resend_forw", "rn_order", "no_auto_forward", "expert_netfwd", "news", "no_dupcc"}
;;#65.("_namelist") = "!include!noinclude!all!sender!nosubject!expert!enter!sticky!@mail!manymsgs!replyto!netmail!expire!followup!resend_forw!rn_order!no_auto_forward!expert_netfwd!news!no_dupcc!"
;;#65.("extras") = {"noinclude", "sender"}
;;#65.("namewidth") = 19
;;#65.("aliases") = {"Mail Options"}
;;#65.("description") = "Options for mailing"
;;#65.("object_size") = {12434, 855068591}

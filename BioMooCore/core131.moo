$Header: /repo/public.cvs/app/BioGate/BioMooCore/core131.moo,v 1.1 2021/07/27 06:44:28 bruce Exp $

>@dump #131 with create
@create $handy_thing named Frand's generic magnetic thing:Frand's generic magnetic thing,generic magnetic thing,magnetic thing
@prop #131."arrive_msg" "" rc
@prop #131."moveto_kludge" 0 r
@prop #131."ticking" 0 r
@prop #131."touched" 1 r
@prop #131."go_home_msg" "" rc
@prop #131."home" #62 r
@prop #131."time_interval" -1 r
;;#131.("aliases") = {"Frand's generic magnetic thing", "generic magnetic thing", "magnetic thing"}
;;#131.("description") = "A magnetic thing is one which is attracted to its home room. After it is picked up, it checks once each time_interval whether it has been touched in any way during the interval. A magnetic thing is touched whenever some verb tells it that it is. This way, you can have a thing which goes home if it is picked up and not used for some period of time. The time_interval is given in seconds. Setting it negative will demagnetize the object."
;;#131.("object_size") = {0, 0}

@verb #131:"moveto" none none none rxd
@program #131:moveto
...
@verb #131:"touch" this none none rxd
@program #131:touch
...
@verb #131:"go_home_msg arrive_msg" none none none rxd
@program #131:go_home_msg
...
@verb #131:"go_somewhere" none none none rxd
@program #131:go_somewhere
...
@verb #131:"go_home" this none none rxd
@program #131:go_home
...
if ((home == #-1) || (valid(home) && home:accept(this)))
  this:go_somewhere(home);
elseif (valid(this.owner.home) && this.owner.home:accept(this))
  this:go_somewhere(this.owner.home);
endif
.

@verb #131:"wait" none none none rxd
@program #131:wait
...
@verb #131:"touch1" none none none rxd
@program #131:touch1
...
@verb #131:"announce" none none none rxd
@program #131:announce
...
@verb #131:"set_h*ome" this to any rxd
@program #131:set_home
...
@verb #131:"set_t*ime" this to any rxd
@program #131:set_time
...
@verb #131:"fixup" this none none rxd
@program #131:fixup
...
@verb #131:"set_home1" none none none rxd
@program #131:set_home1
...
@verb #131:"set_time1" none none none rxd
@program #131:set_time1
...
@verb #131:"fixup1" none none none rxd
@program #131:fixup1
...
@verb #131:"insecure" this none this
@program #131:insecure
...
return !((who in {this.owner, #131.owner}) || who.wizard);
.

@verb #131:"stay_here_after_all" this none this
@program #131:stay_here_after_all
...
@verb #131:"set_moveto_kludge" this none this
@program #131:set_moveto_kludge

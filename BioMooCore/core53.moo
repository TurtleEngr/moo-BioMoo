$Header: /repo/public.cvs/app/BioGate/BioMooCore/core53.moo,v 1.1 2021/07/27 06:44:32 bruce Exp $

>@dump #53 with create
@create $generic_utils named lock utilities:lock utilities
@prop #53."player" #180 rc
@prop #53."input_index" 3 rc
@prop #53."input_length" 2 rc
@prop #53."input_string" "me" rc
...
;;#53.("object_size") = {9742, 1577149626}

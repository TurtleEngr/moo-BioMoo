$Header: /repo/public.cvs/app/BioGate/BioMooCore/core88.moo,v 1.1 2021/07/27 06:44:36 bruce Exp $

>@dump #88 with create
@create $thing named password verifier:password verifier,password,verifier,pwd
@prop #88."minimum_password_length" 0 r
@prop #88."check_against_name" 0 r
@prop #88."check_against_email" 0 r
@prop #88."check_against_hosts" 0 r
@prop #88."check_against_dictionary" 0 r
@prop #88."require_funky_characters" 0 r
@prop #88."help_msg" {} r #36
;;#88.("help_msg") = {"Password Verifier", "==================", "", "To check for the validity of a password, use", "  :reject_password( password [, for-whom? ] )", "... If it returns a true value, that value will contain the string representing the reason why the password was rejected.  If it returns a false value, the password is OK.", "", "The toggle switches for this checking are:"}
@prop #88."check_against_moo" 0 r
@prop #88."check_obscure_stuff" 0 r
;;#88.("aliases") = {"password verifier", "password", "verifier", "pwd"}
;;#88.("description") = "The password verifier verifies passwords."
;;#88.("object_size") = {10953, 1577149627}

@verb #88:"help_msg" this none this rxd #36
@program #88:help_msg
...
@verb #88:"reject_password" this none this
@program #88:reject_password
...
@verb #88:"trivial_check" this none this rxd #36
@program #88:trivial_check
...
@verb #88:"check_length" this none this rxd #36
@program #88:check_length
...
@verb #88:"check_name" this none this rxd #36
@program #88:check_name
pwd = args[1];
...
@verb #88:"check_email" this none this
@program #88:check_email
{pwd, who} = args;
...
@verb #88:"check_hosts" this none this
@program #88:check_hosts
{pwd, who} = args;
if (!$perm_utils:controls(caller_perms(), who))
  return "Permission denied.";
endif
...
@verb #88:"check_dictionary" this none this rxd #36
@program #88:check_dictionary
pwd = args[1];
...
@verb #88:"check_for_funky_characters" this none this rxd #36
@program #88:check_for_funky_characters
...
@verb #88:"check_against_moo" this none this rxd #36
@program #88:check_against_moo
pwd = args[1];
...
@verb #88:"_is_funky_case" this none this rxd #36
@program #88:_is_funky_case
pwd = args[1];
...
@verb #88:"check_obscure_combinations" this none this rxd #36
@program #88:check_obscure_combinations
pwd = args[1];
...
@verb #88:"init_for_core" this none this
@program #88:init_for_core

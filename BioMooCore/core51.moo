$Header: /repo/public.cvs/app/BioGate/BioMooCore/core51.moo,v 1.1 2021/07/27 06:44:32 bruce Exp $

>@dump #51 with create
@create $generic_utils named matching utilities:matching utilities
@prop #51."ordn" {} rc
;;#51.("ordn") = {"first", "second", "third", "fourth", "fifth", "sixth", "seventh", "eighth", "ninth", "tenth"}
@prop #51."ordw" {} rc
;;#51.("ordw") = {"1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th", "9th", "10th"}
@prop #51."ordinal_regexp" "%<%(first%|second%|third%|fourth%|fifth%|sixth%|seventh%|eighth%|ninth%|tenth%|1st%|2nd%|3rd%|4th%|5th%|6th%|7th%|8th%|9th%|10th%)%>" rc
@prop #51."matching_room" #-1 r
;;#51.("help_msg") = {"$match_utils defines the following verbs:", "", "match", "match_nth", "match_verb", "match_list", "parse_ordinal_reference (alias parse_ordref)", "parse_possessive_reference", "object_match_failed", "", "For more documentation, see help $match_utils:<specific verb>."}
;;#51.("aliases") = {"matching utilities"}
;;#51.("description") = "This is a placeholder parent for all the $..._utils packages, to more easily find them and manipulate them. At present this object defines no useful verbs or properties. (Filfre.)"
;;#51.("object_size") = {8626, 855068591}

@verb #51:"match" this none this
@program #51:match
...
@verb #51:"match_nth" this none this
@program #51:match_nth
...
@verb #51:"match_verb" this none this rxd #2
@program #51:match_verb
...
@verb #51:"match_list" this none this
@program #51:match_list
...
@verb #51:"parse_ordinal_reference parse_ordref" this none this
@program #51:parse_ordinal_reference
":parse_ordref(string)";
...
@verb #51:"parse_possessive_reference" this none this
@program #51:parse_possessive_reference
...
@verb #51:"object_match_failed" this none this rx
@program #51:object_match_failed
...
@verb #51:"init_for_core" this none this rxd #2
@program #51:init_for_core

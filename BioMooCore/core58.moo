$Header: /repo/public.cvs/app/BioGate/BioMooCore/core58.moo,v 1.1 2021/07/27 06:44:33 bruce Exp $

>@dump #58 with create
@create $player_class named generic programmer:generic,programmer
@prop #58."eval_subs" {} r #36
@prop #58."eval_ticks" 3 r #36
@prop #58."eval_env" "here=player.location;me=player" r #36
@prop #58."prog_options" {} rc
;;#58.("features") = {#92, #91, #132}
;;#58.("help") = {#22, #28, #18, #19}
;;#58.("home") = #62
;;#58.("size_quota") = {50000, 0, 0, 1}
;;#58.("web_options") = {{"telnet_applet", #110}, "applinkdown", "exitdetails", "map", "embedVRML", "separateVRML"}
;;#58.("aliases") = {"generic", "programmer"}
;;#58.("description") = "You see a player who is too experienced to have any excuse for not having a description."
;;#58.("object_size") = {60771, 1577149627}
;;#58.("vrml_desc") = {"WWWInline {name \"http://hppsda.mayfield.hp.com/image/body.wrl\"}", ""}

@verb #58:"@prop*erty" any any any
@program #58:@property
...
@verb #58:"@rmprop*erty" any any any
@program #58:@rmproperty
set_task_perms(player);
...
@verb #58:"@kill @killq*uiet" any none none
@program #58:@kill
...
@verb #58:"@copy @copy-x @copy-move" any to any
@program #58:@copy
...
@verb #58:"_kill_task_message" this none this
@program #58:_kill_task_message
...
@verb #58:"@prog*ram @program#" any any any
@program #58:@program
...
@verb #58:"@pros*pectus pros*pectus" any any any rxd
@program #58:@prospectus
...
@verb #58:"@d*isplay" any none none
@program #58:@display
...
@verb #58:"@db*size" none none none
@program #58:@dbsize
set_task_perms(player);
"Let 'em @kill it.";
count = 0;
...
@verb #58:"@gethelp" any any any rxd
@program #58:@gethelp
...
@verb #58:"@grep @egrep" any any any
@program #58:@grep
set_task_perms(player);
if (prepstr == "in")
  pattern = dobjstr;
...
@verb #58:"@check-p*roperty" any none none
@program #58:@check-property
...
@verb #58:"set_eval_env" this none this rxd #36
@program #58:set_eval_env
"set_eval_env(string);";
...
@verb #58:"@clearp*roperty @clprop*erty" any none none
@program #58:@clearproperty
...
@verb #58:"@disown @disinherit" any any any
@program #58:@disown
...
@verb #58:"eval_cmd_string" this none this
@program #58:eval_cmd_string
...
@verb #58:"eval_value_to_string" this none this
@program #58:eval_value_to_string
set_task_perms(caller_perms());
...
@verb #58:"@progo*ptions @prog-o*ptions @programmero*ptions @programmer-o*ptions" any any any
@program #58:@progoptions
...
@verb #58:"prog_option" this none this
@program #58:prog_option
":prog_option(name)";
...
@verb #58:"set_prog_option" this none this
@program #58:set_prog_option
...
@verb #58:"set_eval_subs" none none none rxd
@program #58:set_eval_subs
...
@verb #58:"@forked-v*erbose" any none none
@program #58:@forked-verbose

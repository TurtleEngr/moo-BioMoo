$Header: /repo/public.cvs/app/BioGate/BioMooCore/core4.moo,v 1.1 2021/07/27 06:44:31 bruce Exp $

>@dump #4 with create
@create $goes_player named generic builder:generic builder
@prop #4."build_options" {} rc
;;#4.("build_options") = {{"create_flags", "r"}}
;;#4.("features") = {#92, #91, #132}
;;#4.("help") = #85
;;#4.("home") = #62
;;#4.("size_quota") = {50000, 0, 0, 1}
;;#4.("web_options") = {{"telnet_applet", #110}, "applinkdown", "exitdetails", "map", "embedVRML", "separateVRML"}
;;#4.("aliases") = {"generic builder"}
;;#4.("description") = "You see a player who should type '@describe me as ...'."
;;#4.("object_size") = {34630, 1577149622}
;;#4.("vrml_desc") = {"WWWInline {name \"http://hppsda.mayfield.hp.com/image/body.wrl\"}", ""}
...
@verb #4:"@measure" any any any rd #36
@program #4:@measure
"Syntax:";

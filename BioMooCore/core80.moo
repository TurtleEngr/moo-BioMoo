...
@verb #80:"init_for_core" this none this rxd #2
...
@verb #80:"adjust_quota_for_programmer" this none this
@program #80:adjust_quota_for_programmer
return 0;
.

@verb #80:"bi_create" this none this rxd #2
@program #80:bi_create
...
@verb #80:"enable_create" this none this rxd #2
@program #80:enable_create
...
@verb #80:"disable_create" this none this rxd #2
@program #80:disable_create
if ((caller != this) && (!caller_perms().wizard))
  return E_PERM;
else
  args[1].ownership_quota = this.large_negative_number;
...
@verb #80:"parse_create_args" this none this
@program #80:parse_create_args
...
@verb #80:"creation_permitted verb_addition_permitted property_addition_permitted" this none this
@program #80:creation_permitted
...
@verb #80:"all_characters" this none this
@program #80:all_characters
{who} = args;
...
@verb #80:"display_quota" this none this
@program #80:display_quota
who = args[1];
...
@verb #80:"get_quota" this none this
@program #80:get_quota
return args[1].size_quota[1];
.

@verb #80:"charge_quota" this none this
@program #80:charge_quota
...
@verb #80:"reimburse_quota" this none this
@program #80:reimburse_quota
...
@verb #80:"set_quota" this none this
@program #80:set_quota
...
@verb #80:"get_size_quota" this none this
@program #80:get_size_quota
...
@verb #80:"display_quota_summary" this none this
@program #80:display_quota_summary
...
@verb #80:"quota_remaining" this none this
@program #80:quota_remaining
...
@verb #80:"preliminary_reimburse_quota" this none this
@program #80:preliminary_reimburse_quota
...
@verb #80:"value_bytes" this none this rxd #2
@program #80:value_bytes
...
@verb #80:"object_bytes object_size" this none this rxd #2
@program #80:object_bytes
...
@verb #80:"do_summary" any with this rxd
@program #80:do_summary
who = args[1];
...
@verb #80:"summarize_one_user" this none this
@program #80:summarize_one_user
...
@verb #80:"recent_object_bytes" this none this rxd #2
@program #80:recent_object_bytes
...
@verb #80:"measurement_task" this none this rxd #2
@program #80:measurement_task
if (!caller_perms().wizard)
  return E_PERM;
else
  start_time = time();
...
@verb #80:"can_peek" this none this
@program #80:can_peek
return (args[1] == this.owner) || $perm_utils:controls(args[1], args[2]);
.

@verb #80:"can_touch" this none this
@program #80:can_touch
return args[1].wizard;
.

@verb #80:"do_breakdown" this none this rxd #2
@program #80:do_breakdown
dobj = args[1];
...
@verb #80:"object_overhead_bytes" this none this
@program #80:object_overhead_bytes
object = args[1];
return ((13 * 4) + length(object.name)) + 1;
.

@verb #80:"property_overhead_bytes" this none this rxd #2
@program #80:property_overhead_bytes
{o, ?ps = $object_utils:all_properties_suspended(o)} = args;
return (value_bytes(properties(o)) - 4) + ((length(ps) * 4) * 4);
.

@verb #80:"verb_overhead_bytes" this none this rxd #2
@program #80:verb_overhead_bytes
o = args[1];
vs = verbs(o);
return (length(vs) * 5) * 4;
.

@verb #80:"add_owned_object" this none this rxd #2
@program #80:add_owned_object
...
@verb #80:"measurement_task_nofork" this none this rxd #2
@program #80:measurement_task_nofork
...
@verb #80:"measurement_task_body" this none this rxd #2
@program #80:measurement_task_body
if (!caller_perms().wizard)
  return E_PERM;
else
  num_processed = 0;
...
@verb #80:"schedule_measurement_task" this none this rxd #2
@program #80:schedule_measurement_task
if ((caller == this) || caller_perms().wizard)
  day = 24 * 3600;
  hour_of_day_GMT = 8;
...
@verb #80:"task_perms" this none this rxd #2
@program #80:task_perms
...
@verb #80:"property_exists" this none this rxd #2
@program #80:property_exists

...
@verb #33:"contains" this none this
@program #33:contains
":contains(seq,elt) => true iff elt is in seq.";
return ($list_utils:find_insert(@args) + 1) % 2;
.

@verb #33:"complement" this none this
@program #33:complement
...
@verb #33:"extract" this none this
@program #33:extract
...
@verb #33:"from_list" this none this
@program #33:from_list
":fromlist(list) => corresponding sequence.";
return this:from_sorted_list($list_utils:sort(args[1]));
.

@verb #33:"from_sorted_list" this none this
@program #33:from_sorted_list
...
@verb #33:"first" this none this
@program #33:first
return (seq = args[1]) ? seq[1] | E_NONE;
.

@verb #33:"last" this none this
@program #33:last
return (seq = args[1]) ? (length(seq) % 2) ? $minint - 1 | (seq[$] - 1) | E_NONE;
.

@verb #33:"size" this none this
@program #33:size
...
@verb #33:"from_string" this none this
@program #33:from_string
...
@verb #33:"contract" this none this
@program #33:contract
":contract(seq,cseq)";
...
@verb #33:"intersection" this none this
@program #33:intersection

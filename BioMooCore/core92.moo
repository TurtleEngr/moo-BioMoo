$Header: /repo/public.cvs/app/BioGate/BioMooCore/core92.moo,v 1.1 2021/07/27 06:44:36 bruce Exp $

>@dump #92 with create
@create $feature named Pasting Feature:Pasting Feature
;;#92.("help_msg") = "The Pasting Feature is mostly useful to people with fancy clients (such as Emacs) or who connect using a windowing system that allows them to copy text they've already seen.  It's intended to give people a way to quote verbatim text at other people in the room."
;;#92.("feature_verbs") = {"@paste", "|", "@paste-to"}
;;#92.("aliases") = {"Pasting Feature"}
;;#92.("description") = "Verbs useful to people using a windowing system to paste text at people."
;;#92.("object_size") = {3870, 855069281}

@verb #92:"@paste" any any any rxd
@program #92:@paste
...
@verb #92:"@pasteto @paste-to" any none none rxd
@program #92:@pasteto

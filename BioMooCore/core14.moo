...
@verb #14:"_make" this none this rxd #2
@program #14:_make
...
@verb #14:"_kill" this none this rxd #2
@program #14:_kill
...
@verb #14:"_get" this none this
@program #14:_get
return (caller == this._mgr) ? `this.(args[1]) ! ANY' | E_PERM;
.

@verb #14:"_put" this none this
@program #14:_put
return (caller == this._mgr) ? this.(args[1]) = listdelete(args, 1) | E_PERM;
.

@verb #14:"_ord" this none this
@program #14:_ord
return args[1][2..3];
.

@verb #14:"_makemsg" this none this
@program #14:_makemsg
...
@verb #14:"_killmsg" this none this
@program #14:_killmsg
if (caller != this._mgr)
  return E_PERM;
...
@verb #14:"_message_num" this none this
@program #14:_message_num
return args[2];
.

@verb #14:"_message_date" this none this
@program #14:_message_date
return args[3];
.

@verb #14:"_message_hdr" this none this
@program #14:_message_hdr
return args[3..$];
.

@verb #14:"_message_text" this none this
@program #14:_message_text
return {@args[3..$], @args[1] ? {"", @this.(args[1])} | {}};
.

@verb #14:"_lt_msgnum" this none this
@program #14:_lt_msgnum
return args[1] < args[2][1];
.

@verb #14:"_lt_msgdate" this none this
@program #14:_lt_msgdate
return args[1] < args[2][2];
.

@verb #14:"receive_batch" this none this
@program #14:receive_batch
...
@verb #14:"receive_message" this none this
@program #14:receive_message
if (!this:is_writable_by(caller_perms()))
  return E_PERM;
else
...
@verb #14:"messages_in_seq" this none this
@program #14:messages_in_seq
...
@verb #14:"display_seq_headers" this none this
@program #14:display_seq_headers
...
@verb #14:"display_seq_full" this none this
@program #14:display_seq_full
...
@verb #14:"list_rmm" this none this
@program #14:list_rmm
if (!this:ok(caller, caller_perms()))
  return E_PERM;
endif
...
@verb #14:"undo_rmm" this none this
@program #14:undo_rmm
...
@verb #14:"expunge_rmm" this none this
@program #14:expunge_rmm
if (!this:ok_write(caller, caller_perms()))
  return E_PERM;
endif
len = 0;
...
@verb #14:"rm_message_seq" this none this
@program #14:rm_message_seq
seq = args[1];
...
@verb #14:"renumber" this none this
@program #14:renumber
...
@verb #14:"new_message_num" this none this
@program #14:new_message_num
if (this:ok(caller, caller_perms()))
...
@verb #14:"from_msg_seq" this none this
@program #14:from_msg_seq
...
@verb #14:"to_msg_seq" this none this
@program #14:to_msg_seq
...
@verb #14:"subject_msg_seq" this none this
@program #14:subject_msg_seq
...
@verb #14:"body_msg_seq" this none this
@program #14:body_msg_seq
...
@verb #14:"date_sort" this none this
@program #14:date_sort
return E_VERBNF;
.

@verb #14:"_fix_last_msg_date" this none this
@program #14:_fix_last_msg_date
msgtree = this.messages;
this.last_msg_date = (msgtree && this:_message_hdr(@this._mgr:find_nth(msgtree, msgtree[2]))[1]) || 0;
.

@verb #14:"__fix" this none this
@program #14:__fix
if (!this:ok_write(caller, caller_perms()))
  return E_PERM;
endif
...
@verb #14:"init_for_core" this none this rxd #2
@program #14:init_for_core
...
@verb #14:"length_date_gt" this none this
@program #14:length_date_gt
if (this:ok(caller, caller_perms()))
  date = args[1];
...
@verb #14:"_repair" this none this rx #2
@program #14:_repair
c = callers();
...
@verb #14:"repair" this none none rd #2
@program #14:repair
...
@verb #14:"restore_from" this none this rxd #2
@program #14:restore_from

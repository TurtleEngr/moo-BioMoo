$Header: /repo/public.cvs/app/BioGate/BioMooCore/core68.moo,v 1.1 2021/07/27 06:44:34 bruce Exp $

>@dump #68 with create
@create $root_class named Generic Option Package:Generic Option Package
@prop #68."names" {} r
@prop #68."_namelist" "!" r
@prop #68."extras" {} r
@prop #68."namewidth" 15 rc
;;#68.("aliases") = {"Generic Option Package"}
;;#68.("description") = "an option package in need of a description.  See `help $generic_option'..."
;;#68.("object_size") = {12585, 855068591}

@verb #68:"get" this none this
@program #68:get
...
@verb #68:"add_name" this none this
@program #68:add_name
...
@verb #68:"remove_name" this none this
@program #68:remove_name
...
@verb #68:"islistof" this none this
@program #68:islistof
...
@verb #68:"desc_type" this none this
@program #68:desc_type
...
@verb #68:"parsechoice" this none this
@program #68:parsechoice

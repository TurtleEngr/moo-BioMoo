$Header: /repo/public.cvs/app/BioGate/BioMooCore/core37.moo,v 1.1 2021/07/27 06:44:31 bruce Exp $

>@dump #37 with create
@create $root_class named Generic Database:Generic Database
@prop #37."node_perms" "r" rc
@prop #37."data" 4 r
@prop #37." " {} ""
;;#37.(" ") = {"", "", {}, {}}
;;#37.("aliases") = {"Generic Database"}
;;#37.("description") = "A generic `database' (well, really more like a string-indexed array if you want the truth...). See `help $generic_db' for details."
;;#37.("object_size") = {15830, 855068591}

@verb #37:"find find_key" this none this
@program #37:find
...
@verb #37:"find_exact" this none this
@program #37:find_exact
{search, ?sofar = 0} = args;
rest = search;
prefix = search[1..sofar];
rest[1..sofar] = "";
...
@verb #37:"find_all find_all_keys" this none this
@program #37:find_all
":find_all(string [,n=0])";
"assumes n <= length(string)";
{search, ?sofar = 0} = args;
...
@verb #37:"_every_key" this none this
@program #37:_every_key
if (caller != this)
  raise(E_PERM);
endif
info = this.(" " + args[1]);
...
@verb #37:"delete2" this none this
@program #37:delete2
...
@verb #37:"clearall_big" this none this
@program #37:clearall_big
if (!($perm_utils:controls(caller_perms(), this) || (caller == this)))
  return E_PERM;
endif
...
@verb #37:"_kill_subtrees" this none this
@program #37:_kill_subtrees
...
@verb #37:"count_entries" this none this
@program #37:count_entries
info = this.(" " + (prefix = args[1]));
...
@verb #37:"count_chars" this none this
@program #37:count_chars
info = this.(" " + (prefix = args[1]));
count = args[2];
for s in (info[3])

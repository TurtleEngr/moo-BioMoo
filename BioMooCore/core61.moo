...
@verb #61:"is_writable_by" this none this rxd #2
@program #61:is_writable_by
return pass(@args) || (args[1] in $list_utils:map_prop($object_utils:descendants($wiz), "mail_identity"));
.

@verb #61:"rm_message_seq" this none this
@program #61:rm_message_seq
...
@verb #61:"undo_rmm" this none this
@program #61:undo_rmm
if (!this:ok_write(caller, caller_perms()))
  return E_PERM;
endif
...
@verb #61:"expunge_rmm" this none this
@program #61:expunge_rmm
if (!this:ok_write(caller, caller_perms()))
  return E_PERM;
endif
this.current_news_going = {};
...
@verb #61:"set_current_news" this none this
@program #61:set_current_news
if (!this:ok_write(caller, caller_perms()))
  return E_PERM;
else
...
@verb #61:"add_current_news" this none this
@program #61:add_current_news
if (!this:ok_write(caller, caller_perms()))
  return E_PERM;
else
...
@verb #61:"rm_current_news" this none this
@program #61:rm_current_news
if (!this:ok_write(caller, caller_perms()))
  return E_PERM;
else
...
@verb #61:"news_display_seq_full" this none this rxd #2
@program #61:news_display_seq_full
...
@verb #61:"to_text" this none this
@program #61:to_text
...
@verb #61:"check" this none this rxd #2
@program #61:check
set_task_perms(caller_perms());
...
@verb #61:"touch" this none none rxd #2
@program #61:touch
...
@verb #61:"@addnews" any to this rxd #2
@program #61:@addnews
...
@verb #61:"@rmnews" any from this rxd #2
@program #61:@rmnews
if ((caller_perms() != #-1) && (caller_perms() != player))
  raise(E_PERM);
endif
...
@verb #61:"@setnews" this to any rd #2
@program #61:@setnews
set_task_perms(player);
if (!this:is_writable_by(player))
  player:notify("You can't write the news.");
...
@verb #61:"init_for_core" this none this rxd #2
@program #61:init_for_core
if (caller_perms().wizard)
  ...
  this.mail_forward = {};
  for p in ({"moderator_forward", "writers", "last_used_time", "mail_notify"})
...
@verb #61:"add_news" this none this rxd #2
@program #61:add_news
if (!this:ok_write(caller, caller_perms()))
  $error:raise(E_PERM);
endif
...
@verb #61:"rm_news" this none this rxd #2
@program #61:rm_news
if (!this:ok_write(caller, caller_perms()))
  raise(E_PERM);
endif

$Header: /repo/public.cvs/app/BioGate/BioMooCore/core5.moo,v 1.1 2021/07/27 06:44:32 bruce Exp $
...
@prop #5."about_msg" "I don't know much about %t." rc
;;#5.("aliases") = {"generic thing"}
;;#5.("object_size") = {4875, 1577149622}

...
@verb #24:"set_player" this none this
@program #24:set_player
...
@verb #24:"set_owner" this none this
@program #24:set_owner
...
@verb #24:"set_property_owner" this none this
@program #24:set_property_owner
...
@verb #24:"unset_player" this none this
@program #24:unset_player
...
@verb #24:"set_property_flags" this none this
@program #24:set_property_flags
...
@verb #24:"_set_property_flags" this none this
@program #24:_set_property_flags
...
@verb #24:"random_password" this none this
@program #24:random_password
...
@verb #24:"queued_tasks" this none this
@program #24:queued_tasks
...
@verb #24:"player_cmd_perms" this none this
@verb #24:"isnewt" this none this
@program #24:isnewt
...
@verb #24:"initialize_owned" this none this
@program #24:initialize_owned
if (!caller_perms().wizard)
  return E_PERM;
else
  set_task_perms(caller_perms());
...
@verb #24:"verify_owned_objects" this none this
@program #24:verify_owned_objects
if (!caller_perms().wizard)
  return E_PERM;
else
  for p in (players())
...
@verb #24:"connected_wizards connected_wizards_unadvertised" this none this rxd #36
@program #24:connected_wizards
...
@verb #24:"all_wizards_advertised all_wizards all_wizards_unadvertised" this none this rxd #36
@program #24:all_wizards_advertised
...
@verb #24:"rename_all_instances" this none this
@program #24:rename_all_instances
...
@verb #24:"missed_help" this none this
@program #24:missed_help
...
@verb #24:"show_missing_help" this none this
@program #24:show_missing_help
...
@verb #24:"init_for_core" this none this
@program #24:init_for_core
if (caller_perms().wizard)
  pass();
...
@verb #24:"show_netwho_listing" this none this
@program #24:show_netwho_listing
...
@verb #24:"show_netwho_from_listing" this none this
@program #24:show_netwho_from_listing
...
@verb #24:"check_player_request check_reregistration" this none this
@program #24:check_player_request
...
@verb #24:"make_player" this none this
@program #24:make_player
...
@verb #24:"send_new_player_mail" this none this
@program #24:send_new_player_mail
...
@verb #24:"do_make_player" any any any rxd
@program #24:do_make_player
...
@verb #24:"do_register" this none this
@program #24:do_register
...
@verb #24:"do_new_password" this none this
@program #24:do_new_password
...
@verb #24:"set_owner_new" this none this
@program #24:set_owner_new
":set_owner(object,newowner[,suspendok])  does object.owner=newowner, taking care of c properties as well.  This should be used anyplace one is contemplating doing object.owner=newowner, since the latter leaves ownership of c properties unchanged.  (--Rog thinks this is a server bug).";
{object, newowner, ?suspendok = 0} = args;
if (!valid(object))
  return E_INVIND;
...
@verb #24:"boot_idlers" this none this
@program #24:boot_idlers
if (!caller_perms().wizard)
  return E_PERM;
endif
"------- constants ---- ";
...
@verb #24:"grant_object" this none this
@program #24:grant_object
...
@verb #24:"connection_hash" this none this
@program #24:connection_hash
...
@verb #24:"newt_player" this none this
@program #24:newt_player
...
@verb #24:"unset_programmer" this none this
@program #24:unset_programmer
...
@verb #24:"is_wizard" this none this rxd #36
@program #24:is_wizard
...
@verb #24:"expire_mail" none none none rxd
@program #24:expire_mail
if (!caller_perms().wizard)
  return E_PERM;
endif
...
@verb #24:"expire_mail_weekly" this none this
@program #24:expire_mail_weekly
if (!caller_perms().wizard)
  return E_PERM;
endif
fork (((7 * 24) * 60) * 60)
...
@verb #24:"check_prog_restricted" this none this
@program #24:check_prog_restricted
...
@verb #24:"expire_mail_players" this none this
@program #24:expire_mail_players
if (!caller_perms().wizard)
  return E_PERM;
endif
s = 0;
...
@verb #24:"expire_mail_lists" this none this
@program #24:expire_mail_lists
if (!caller_perms().wizard)
  return E_PERM;
endif
sum = 0;
...
@verb #24:"flush_editors" this none this
@program #24:flush_editors
if (!caller_perms().wizard)
  return E_PERM;
else
  fork (86400 * 7)
...
@verb #24:"random_wizard" this none this
@program #24:random_wizard
...
@verb #24:"call_verb_with_other_perms" this none this rx #95
@program #24:call_verb_with_other_perms

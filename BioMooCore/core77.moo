$Header: /repo/public.cvs/app/BioGate/BioMooCore/core77.moo,v 1.1 2021/07/27 06:44:35 bruce Exp $
...
;;#77.("type_dig_exit") = {1}
;;#77.("names") = {"dig_room", "dig_exit", "create_flags", "bi_create"}
;;#77.("_namelist") = "!dig_room!dig_exit!create_flags!bi_create!"
;;#77.("namewidth") = 20
;;#77.("aliases") = {"Builder Options"}
;;#77.("description") = {"Option package for $builder commands.  See `help @build-options'."}
;;#77.("object_size") = {3619, 855068591}
